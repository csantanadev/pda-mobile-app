...
export default function ArtilheiroMes() {
  ...
  async function getdados() {
    ...
    try {
      setLoading(true);
      const response = await api.get('Dashboard/artilharia_mes/');
          ...
          !loading && (
            <>
              ...
              <FlatList
                ...
                keyExtractor={item => item.pda_jog_apelido + item.mes_extenso}
